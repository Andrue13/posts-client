...
import userLoginForm from '../services/loginFormHook';
...
export default function SignIn() {
  const { email,
    ...
    isPasswordError,
    setIsEmailError,
    setisPasswordError } = userLoginForm()
  ...
  return (
    <ThemeProvider theme={theme}>
          ...
          <Box component="form" onSubmit={handleSubmit} noValidate sx={{ mt: 1 }}>
            <TextField
              ...
              helperText={isEmailError
                ? (formErrorMessages.email ? formErrorMessages.email : "Incorrect entry.")
                : null}
              error={isEmailError}
            />
            <TextField
      ...
      <Snackbar open={submitError !== FormError.NONE} autoHideDuration={5000} onClose={handleClose}>
